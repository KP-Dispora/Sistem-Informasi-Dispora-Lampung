...
function App() {
  return (
    <Routes>
      ...
      <Route
        exact
        path="/login_admin_arsip_surat"
        element={<LoginAdminArsipSurat />}
      />
      <Route
        exact
        path="/dashboard_admin_arsip_surat"
        element={<DashboardAdminArsipSurat />}
      />
      <Route
        exact
        path="/profil_admin_arsip_surat"
        element={<ProfilAdminArsipSurat />}
      />
      <Route
        exact
        path="/profil_admin_arsip_surat/edit"
      ...
      <Route
        exact
        path="/admin_surat_masuk/tambah"
        element={<TambahSuratMasukPage />}
      />
      <Route
        exact
        path="/admin_surat_masuk/detail/:id"
        element={<DetailSuratMasuk />}
      />
      <Route
        exact
        path="/admin_surat_masuk/edit/:id"
        element={<EditSuratMasuk />}
      />
      <Route exact path="/admin_surat_keluar" element={<SuratKeluarPage />} />
      <Route
        exact
        path="/admin_surat_keluar/tambah"
        element={<TambahSuratKeluarPage />}
      />
      <Route
        exact
        path="/admin_surat_keluar/detail/:id"
        element={<DetailSuratKeluar />}
      />
      <Route
        exact
        path="/admin_surat_keluar/edit/:id"
      ...
      <Route
        exact
        path="/arsip_surat/surat_masuk"
        element={<SuratMasukPublic />}
      />
      <Route
        exact
        path="/arsip_surat/surat_masuk/detail/:id"
        element={<DetailSuratMasukPublic />}
      />
      <Route
        exact
        path="/arsip_surat/surat_keluar"
        element={<SuratKeluarPublic />}
      />
      <Route
        exact
        path="/arsip_surat/surat_keluar/detail/:id"
        element={<DetailSuratKeluarPublic />}
      />
      ...
      <Route
        exact
        path="/login_admin_proposal"
        element={<LoginAdminProposal />}
      />
      <Route
        exact
        path="/dashboard_admin_proposal"
        element={<DashboardAdminProposal />}
      />
      <Route
        exact
        path="/profil_admin_proposal"
        element={<ProfilAdminProposal />}
      />
      <Route
        exact
        path="/profil_admin_proposal/edit"
        element={<EditProfilAdminProposal />}
      />
    </Routes>
  );
}
