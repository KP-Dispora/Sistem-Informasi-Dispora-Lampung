...
function Home() {
    return (
      <div>
        ...
        <h1 className="text-center my-5"> <span className="text-judul-si py-2 px-4">Pengajuan Proposal</span> </h1>
          ...
          <div className="row row-cols-1 row-cols-md-2 gx-5 gy-5">
            <div className="col">
              <div className="card w-75 h-100 mx-auto">
                ...
                <div className="card-body">
                  <h5 className="card-title">Ajukan Proposal</h5>
            ...
            <div className="col">
              <div className="card w-75 h-100 mx-auto">
                <EnvelopePaperFill className="card-img-top mt-4" size={160} />
                <div className="card-body">
                  <h5 className="card-title">Cek Proposal</h5>
